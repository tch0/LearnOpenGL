...
{
    Utils::Renderer renderer("02NormalMap.cpp");
    renderer.setFaceCullingAttribute(false, GL_BACK, GL_CCW);
    ...
    // models
    std::shared_ptr<Utils::Model> spPlane(new Utils::Plane(0.0f, 100.0f, 10.0f, 10));
