...
void display(GLFWwindow* window, double currentTime)
{
    ...
    // move the triangle rotate, with increment of 0.02f per rendering
    angle += 0.02f;
    GLuint angleLoc = glGetUniformLocation(renderingProgram, "angle"); // get offset pointer
    glProgramUniform1f(renderingProgram, angleLoc, angle); // pass x to offset, it can be accessed in vertex shader
